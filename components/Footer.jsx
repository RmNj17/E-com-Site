        ...
        <footer className="text-gray-600 body-font bg-gray-50">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
                    ...
                    <span className="mt-2 block text-black font-semibold text-xl">Sasto Ramro Store</span>
                    <p className="mt-2 text-sm text-gray-500">Easy and Fast online shopping store</p>
                </div>
                <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Childrens</a>
                            </li>
                            <li>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">srs@gmail.com</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">011-23456</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">www.sastoramro.com</a>
                            </li>
                        </nav>
                    </div>
                </div>
